...
/**
 * Phase 284 — a DECLARED shared receive end: JCSP's {@code one2any}, one writer and many competing readers.
 *
 * <p>By default a channel is point-to-point — one live process per end — and a second receiver is refused
 ...
 * CONTRACT (Phase 242) still holds, because every receiver must satisfy it; and deadlock-freedom still holds,
