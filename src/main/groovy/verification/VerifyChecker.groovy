...
import static verification.ChannelDesugar.*
...
class VerifyChecker extends TypeCheckingExtension implements CheckerApi {
    ...
    static boolean probeClaimSelect() {
    ...
    static boolean probeGuardedSelect() {
    ...
    static boolean isNonIntScalar(ClassNode t) {
        if (t == null) return false
    ...
    static boolean noArgs(MethodCallExpression mce) {
    ...
    static final List<String> CHANNEL_DRAIN_OPS = ['toList', 'each', 'collect'].asImmutable()
    ...
    static void collectBodyLocalNames(BlockStatement body, Set<String> out) {
        body.visit(new CodeVisitorSupport() {
            @Override void visitDeclarationExpression(DeclarationExpression de) {
                if (de.leftExpression instanceof VariableExpression) {
    ...
    static Statement boundsAssert(Expression subject, List<long[]> bounds, ASTNode pos) {
