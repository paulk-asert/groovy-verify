...
class G296_p225_collections_specs {
    ...
    static final List<Map> CASES = [
        ...
        [group: 'P225 collections specs', name: 'frequency IS count: the exact fact links (list-name registration)', ok: true,
         src: tc('''class C {
                        @Requires({ xs != null })
        ...
        [group: 'P225 collections specs', name: 'frequency with the wrong needle refutes', expect: 'Cannot prove postcondition',
         src: tc('''class C {
                        @Requires({ xs != null })
