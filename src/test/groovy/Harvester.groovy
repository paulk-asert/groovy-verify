...
class Harvester {
    ...
    static final Map<String, String> GROUP_DESC = [
        ...
        'P107 ring-buffer'            : "A ring buffer as a mutable data structure: enqueue/dequeue preserve the class @Invariant under @Modifies framing; an over-strong frame refutes.",
