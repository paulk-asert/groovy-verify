...
class Harvester {
    ...
    static final Map<String, String> GROUP_DESC = [
        ...
        'P164 dutch-flag'             : "Dijkstra's Dutch National Flag — the in-place three-way partition proven sorted from a four-region loop @Invariant (reds | whites | unknown | blues) over three moving indices with @Decreases (hi - mid); the classic off-by-one (mid++ after the blue swap) refutes at invariant preservation.",
