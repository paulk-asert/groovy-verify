...
**precompiled/imported** class (resolving the receiver through the import table), the §III-A control-variable
obligation, array element labels, and principled declassification.
